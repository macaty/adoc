...
# aardio 鑼冧緥: WebSocket/JSON-RPC 2.0 瀹㈡埛绔紝鏀寔 wss 鍗忚

```aardio aardio
//WSS-JSON-RPC瀹㈡埛绔?import win.ui;
/*DSG{{*/
var winform = win.form(text="WebSocket/JSON-RPC 2.0 瀹㈡埛绔紝鏀寔 wss 鍗忚 ";right=770;bottom=467)
winform.add(
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/Web/WebSocket/wssJsonClient.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/Web/WebSocket/wssJsonClient.md')
