...
# aardio 范例: WebSocket/JSON-RPC 2.0 客户端，支持 wss 协议

```aardio aardio
//WSS-JSON-RPC客户�?import win.ui;
/*DSG{{*/
...
[Markdown 格式](https://www.aardio.com/zh-cn/doc/example/Web/WebSocket/wssJsonClient.md)
