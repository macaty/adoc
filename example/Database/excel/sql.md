...
# aardio 鑼冧緥: access 搴?- SQL 鎿嶄綔 Excel

```aardio aardio
//access 搴?- SQL 鎿嶄綔 Excel
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/Database/excel/sql.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/Database/excel/sql.md')
