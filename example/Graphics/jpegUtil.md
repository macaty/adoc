...
# aardio 鑼冧緥: JPEG 鍘嬬缉杞崲宸ュ叿 - 澶嶅埗鍥惧儚鑷姩鍔犺浇
...
/*DSG{{*/
var winform = win.form(text="JPEG 鍘嬬缉杞崲宸ュ叿 - 澶嶅埗鍥惧儚鑷姩鍔犺浇";right=1151;bottom=661)
winform.add(
btnChangeJpegExtension={cls="plus";text="鏇存敼";left=334;top=604;right=431;bottom=634;align="left";color=3947580;db=1;dl=1;font=LOGFONT(h=-13);iconStyle={align="left";font=LOGFONT(h=-13;name='FontAwesome');padding={left=8}};iconText='\uF0C7';notify=1;textPadding={left=25};z=11};
btnClipboard={cls="plus";text="鑷壀璐存澘鍔犺浇鍥惧儚";left=606;top=608;right=765;bottom=638;align="left";color=3947580;db=1;dr=1;font=LOGFONT(h=-13);iconStyle={align="left";font=LOGFONT(h=-13;name='FontAwesome');padding={left=8}};iconText='\uF0EA';notify=1;textPadding={left=25};z=8};
btnOpen={cls="plus";text="鍔犺浇鍥惧儚";left=784;top=608;right=881;bottom=638;align="left";color=3947580;db=1;dr=1;font=LOGFONT(h=-13);iconStyle={align="left";font=LOGFONT(h=-13;name='FontAwesome');padding={left=8}};iconText='\uF03E';notify=1;textPadding={left=25};z=6};
btnSave={cls="plus";text="淇濆瓨鍥惧儚";left=910;top=606;right=1007;bottom=636;align="left";color=3947580;db=1;dr=1;font=LOGFONT(h=-13);iconStyle={align="left";font=LOGFONT(h=-13;name='FontAwesome');padding={left=8}};iconText='\uF0C7';notify=1;textPadding={left=25};z=7};
...
static={cls="static";text="杈撳嚭璐ㄩ噺:";left=101;top=559;right=221;bottom=583;align="right";db=1;dl=1;transparent=1;z=4};
static2={cls="static";text="绯荤粺淇濆瓨JPEG鏂囦欢浣跨敤鐨勯粯璁ゅ悗缂�:";left=30;top=611;right=235;bottom=634;align="right";db=1;dl=1;transparent=1;z=9};
...
winform.btnOpen.oncommand = function(id,event){
    var path = fsys.dlg.open("鍥惧儚鏂囦欢|*.jpg;*.jpeg;*.jfif;*.bmp;*.gif;*.png;*.tif;*.tiff||",,,winform)
    if(path){
...
winform.btnChangeJpegExtension.oncommand = function(id,event){
    ...
    if(reg){
        ...
        winform.msgOk("宸蹭慨鏀?JPEG 榛樿鍚庣紑鍚?)
    }
}
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/Graphics/jpegUtil.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/Graphics/jpegUtil.md')
