...
# aardio 鑼冧緥: 璋冪敤 MPlayer 瑙嗛鎾斁鍣紙鎸夊洖杞﹀叏灞忥紝鎸夌┖鏍兼殏鍋滐級

```aardio aardio
import fonts.fontAwesome;
import win.ui;
/*DSG{{*/
var winform = win.form(text="璋冪敤 MPlayer 瑙嗛鎾斁鍣紙鎸夊洖杞﹀叏灞忥紝鎸夌┖鏍兼殏鍋滐級";right=856;bottom=483;bgcolor=16515070)
winform.add(
...
winform.btnPlay.oncommand = function(id,event){
    if(!mplayer.isPlaying()){
        ...
        elseif( mplayer.loadfile( fsys.dlg.open(,"璇锋寚瀹氳棰戞枃浠?) ) ){
...
//鎸夌┖鏍兼殏鍋?winform.translateAccelerator = function(msg){
    if(  msg.wParam == 0x20/*_VK_SPACE*/ && msg.message = 0x101/*_WM_KEYUP*/){
        return true;
    }
}

//鎸夊洖杞﹀叏灞?winform.onOk = function(){
    winform.video.fullscreen();
}

//鎸夊洖杞﹀叏灞?winform.video.onOk = function(){
    winform.video.fullscreen();
}

//鎸?ESC 閫�鍑哄叏灞?winform.video.onCancel = function(){
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/Media/Video/mplayer.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/Media/Video/mplayer.md')
