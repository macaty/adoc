...
# aardio 范例: fsys.media 音频播放控制，显示播放进�?
```aardio aardio
//fsys.media
import win.ui;
import fonts.fontAwesome;
/*DSG{{*/
var winform = win.form(text="fsys.media 音频播放控制，显示播放进�?;right=534;bottom=84)
winform.add(
...
[Markdown 格式](https://www.aardio.com/zh-cn/doc/example/Media/Audio/fsys.media.md)
