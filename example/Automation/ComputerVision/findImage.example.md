...
imgWindow.captureWindow(hwnd);//濡傛灉鎵句笉鍒板嚱鏁帮紝鍏堣繍琛?file://~/tools/ext.aardio 鏇存柊鎵╁睍搴撱�?
//鏌ユ壘鐩爣鍥惧儚
var sm,x,y = imgFind.findImage( imgWindow );//娉ㄦ剰锛氶粯璁ゅ绐楀彛瀹㈡埛鍖烘埅鍥撅紝娉ㄦ剰杩欓噷鐨勫潗鏍囧弬鏁板繀椤绘槸绐楀彛瀹㈡埛鍖哄潗鏍囷紙涓嶅惈绯荤粺鏍囬鏍忥紝涓嶆槸鎸囪嚜缁樻爣棰樻爮锛?
//绉诲姩榧犳爣
import mouse;
...
//绉诲姩榧犳爣鍒扮洰鏍囧浘鍍忓彸涓嬭锛屾樉绀洪紶鏍囪建杩?mouse.moveToWindow(x,y,hwnd,8);

```

[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/Automation/ComputerVision/findImage.example.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/Automation/ComputerVision/findImage.example.md')
