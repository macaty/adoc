...
import win.ui;
/*DSG{{*/
var winform = win.form(text="鐗规畩鏂囦欢澶?;right=1071;bottom=815)
winform.add(
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/File/SpecialPath/io.getSpecial.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/File/SpecialPath/io.getSpecial.md')
