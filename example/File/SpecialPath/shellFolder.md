...
# aardio 鑼冧緥: 鎵撳紑绯荤粺闅愯棌鐩綍

```aardio aardio
//鎵撳紑闅愯棌鐩綍
import win.ui;
/*DSG{{*/
var winform = win.form(text="鎵撳紑绯荤粺闅愯棌鐩綍";right=759;bottom=469)
winform.add(
...
static={cls="static";text="绯荤粺鏈変竴浜涚壒娈婄殑闅愯棌鐩綍锛屽彲浠ヨ皟鐢ㄤ笂闈㈢殑 aardio 浠ｇ爜鐩存帴鎵撳紑銆?;left=13;top=440;right=436;bottom=465;db=1;dl=1;dr=1;transparent=1;z=2}
)
/*}}*/
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/File/SpecialPath/shellFolder.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/File/SpecialPath/shellFolder.md')
