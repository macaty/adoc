...
# aardio 鑼冧緥: WinAsar - Asar 鏂囦欢鎵撳寘銆佽В鍖呭伐鍏?
```aardio aardio
import fonts.fontAwesome;
import win.ui;
/*DSG{{*/
mainForm = win.form(text="WinAsar - Asar 鏂囦欢鎵撳寘銆佽В鍖呭伐鍏?;right=1019;bottom=679;bgcolor=15793151;border="none")
mainForm.add(
caption={cls="bkplus";text="WinAsar - Asar 鏂囦欢鎵撳寘銆佽В鍖呭伐鍏?;left=67;top=9;right=723;bottom=27;align="left";color=6052956;dl=1;dt=1;font=LOGFONT(h=-14);z=7};
...
nav1={cls="plus";text="鎵撳寘";left=0;top=48;right=85;bottom=128;bkBottom=3;bkLeft=7;bkRight=8;bkTop=2;border={color=-65536};color=16777215;dl=1;dt=1;font=LOGFONT(h=-15);iconStyle={font=LOGFONT(h=-37;name='FontAwesome');padding={bottom=20}};iconText='\uF0B1';notify=1;textPadding={bottom=10};valign="bottom";x=0.5;y=0.20000000298023;z=3};
nav2={cls="plus";text="瑙ｅ寘";left=0;top=129;right=85;bottom=209;bkBottom=3;bkLeft=7;bkRight=8;bkTop=2;border={color=-65536};color=16777215;dl=1;dt=1;font=LOGFONT(h=-15);iconStyle={font=LOGFONT(h=-37;name='FontAwesome');padding={bottom=20}};iconText='\uF0E8';notify=1;textPadding={bottom=10};valign="bottom";x=0.5;y=0.20000000298023;z=5};
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/File/asar/main.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/File/asar/main.md')
