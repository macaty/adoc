...
# aardio 范例: WinAsar - Asar 文件打包、解包工�?
```aardio aardio
import fonts.fontAwesome;
import win.ui;
/*DSG{{*/
mainForm = win.form(text="WinAsar - Asar 文件打包、解包工�?;right=1019;bottom=679;bgcolor=15793151;border="none")
mainForm.add(
caption={cls="bkplus";text="WinAsar - Asar 文件打包、解包工�?;left=67;top=9;right=723;bottom=27;align="left";color=6052956;dl=1;dt=1;font=LOGFONT(h=-14);z=7};
...
[Markdown 格式](https://www.aardio.com/zh-cn/doc/example/File/asar/main.md)
