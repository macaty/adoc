...
winform.add(
btnBuild={cls="plus";text="鐢熸垚asar鏂囦欢";left=805;top=664;right=967;bottom=701;align="left";db=1;dr=1;font=LOGFONT(h=-15);iconStyle={align="left";font=LOGFONT(name='FontAwesome');padding={left=15}};iconText='\uF090';notify=1;textPadding={left=35};z=3};
btnClear={cls="plus";text="娓呯┖";left=272;top=8;right=355;bottom=43;align="left";dl=1;dt=1;font=LOGFONT(h=-15);iconStyle={align="left";font=LOGFONT(name='FontAwesome');padding={left=15}};iconText='\uF1F8';textPadding={left=35};z=8};
btnOpen={cls="plus";text="娣诲姞";left=25;top=8;right=129;bottom=43;align="left";dl=1;dt=1;font=LOGFONT(h=-15);iconStyle={align="left";font=LOGFONT(name='FontAwesome');padding={left=15}};iconText='\uF07C';textPadding={left=35};z=5};
btnRemove={cls="plus";text="绉婚櫎";left=135;top=8;right=239;bottom=43;align="left";disabled=1;dl=1;dt=1;font=LOGFONT(h=-15);iconStyle={align="left";font=LOGFONT(name='FontAwesome');padding={left=15}};iconText='\uF08B';textPadding={left=35};z=9};
...
lbTip={cls="plus";text="鍙洿鎺ユ嫋鏀捐娣诲姞鐨勬枃浠跺埌褰撳墠绐椾綋";left=382;top=706;right=663;bottom=728;align="right";db=1;dr=1;transparent=1;z=11};
...
static={cls="static";text="杈撳嚭鏂囦欢:";left=42;top=672;right=128;bottom=696;align="right";db=1;dl=1;font=LOGFONT(h=-15);transparent=1;z=7};
...
winform.btnOpen.oncommand = function(id,event){
    var path = fsys.dlg.open("*.*|*.*||","娣诲姞鏂囦欢鍒癮sar鏂囦欢",,winform.hwnd);
    if(#path){
        asarFile.add( path );
        showAsarInfo();
    }
...
winform.btnBuild.oncommand = function(id,event){
    ...
    if(!#outpath){
        outpath = fsys.dlg.save("*.asar|*.asar||","璇烽�夋嫨asar鏂囦欢",,winform.hwnd);
    }

    if(!#outpath) return;
    if(!..string.endWith(outpath,".asar",true)){
        winform.msgboxErr("杈撳嚭鏂囦欢蹇呴』浠?asar浣滀负鏂囦欢鍚嶅悗缂�");
...
[Markdown 鏍煎紡](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/example/File/asar/forms/packer.md  \n\n该文件无法用 Teleport Ultra 下载, 因为 它不在项目文件类型规范内。  \n\n你想在服务器上打开它?'))window.location='https://www.aardio.com/zh-cn/doc/example/File/asar/forms/packer.md')
