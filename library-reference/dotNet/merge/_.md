...
此扩展库基于 ILMerge
文档�?[https://github.com/dotnet/ILMerge/blob/master/ilmerge-manual.md](https://github.com/dotnet/ILMerge/blob/master/ilmerge-manual.md)
...
每个启动参数都是使用斜杠开始的字符�?
所有可用参�?[https://github.com/dotnet/ILMerge/blob/master/ilmerge-manual.md](https://github.com/dotnet/ILMerge/blob/master/ilmerge-manual.md)
...
[Markdown 格式](https://www.aardio.com/zh-cn/doc/library-reference/dotNet/merge/_.md)
