...
var msTscAx = rdpClient.\_object;//获取控件对象 [https://docs.microsoft.com/en-us/windows/win32/termserv/mstscax](javascript:if(confirm('https://docs.microsoft.com/en-us/windows/win32/termserv/mstscax  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ������·���ⲿ������Ϊ������ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ�����?'))window.location='https://docs.microsoft.com/en-us/windows/win32/termserv/mstscax')
...
用户�?
[Markdown 格式](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/library-reference/win/ts/_.md  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ��������Ŀ�ļ����͹淶�ڡ�  \n\n�����ڷ������ϴ�����?'))window.location='https://www.aardio.com/zh-cn/doc/library-reference/win/ts/_.md')
