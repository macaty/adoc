...
TinyCC 文档�?[http://bellard.org/tcc/tcc-doc.html](javascript:if(confirm('http://bellard.org/tcc/tcc-doc.html  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ������·���ⲿ������Ϊ������ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ�����?'))window.location='http://bellard.org/tcc/tcc-doc.html')

完整头文件下�? [http://download.savannah.gnu.org/releases/tinycc/winapi-full-for-0.9.27.zip](javascript:if(confirm('http://download.savannah.gnu.org/releases/tinycc/winapi-full-for-0.9.27.zip  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ��������Ŀ�ļ����͹淶�ڡ�  \n\n�����ڷ������ϴ�����?'))window.location='http://download.savannah.gnu.org/releases/tinycc/winapi-full-for-0.9.27.zip')
...
[Markdown 格式](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/library-reference/tcc/_.md  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ��������Ŀ�ļ����͹淶�ڡ�  \n\n�����ڷ������ϴ�����?'))window.location='https://www.aardio.com/zh-cn/doc/library-reference/tcc/_.md')
