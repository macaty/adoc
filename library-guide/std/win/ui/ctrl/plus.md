...
请参考教�?[《trackbar 控件高级玩法》](javascript:if(confirm('https://mp.weixin.qq.com/s?__biz=MzA3Njc1MDU0OQ==&mid=2650931907&idx=1&sn=2543aee4c3e32393c8361f0dd43d8667&chksm=84aa2979b3dda06fcb8c590caba5b11eeb3eebcec5608fdb7944dc792566ea417a5ab3b64996&scene=178&cur_album_id=2209804829378543621  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ����һ������·���ⲿ������Ϊ������ʼ��ַ�ĵ�ַ��  \n\n�����ڷ������ϴ�����?'))window.location='https://mp.weixin.qq.com/s?__biz=MzA3Njc1MDU0OQ==&mid=2650931907&idx=1&sn=2543aee4c3e32393c8361f0dd43d8667&chksm=84aa2979b3dda06fcb8c590caba5b11eeb3eebcec5608fdb7944dc792566ea417a5ab3b64996&scene=178&cur_album_id=2209804829378543621#rd')
...
## plus 控件创建静态控�?
plus 控件用于静态显示图像或背景色时，也可以作为文本框的背景用于美化文本框。需要注�?plus 控件作为背景控件使用时要设置【事件回调】为false�?这个是默认值，表示不响应鼠标按键事�?）以避免与文本框争抢绘图�?
文本框用于显示单行文本时可以将高度调整的较小，加上背景图显示效果就比较好了�?注意要在属性面板中设置【多行】属性为false，多行文本框调整太小了光标就看不到了�?
[Markdown 格式](javascript:if(confirm('https://www.aardio.com/zh-cn/doc/library-guide/std/win/ui/ctrl/plus.md  \n\n���ļ��޷��� Teleport Ultra ����, ��Ϊ ��������Ŀ�ļ����͹淶�ڡ�  \n\n�����ڷ������ϴ�����?'))window.location='https://www.aardio.com/zh-cn/doc/library-guide/std/win/ui/ctrl/plus.md')
