...
注意在原�?API 函数中，struct 对象总是传址（传结构体指针），如果是按值传递的结构体，可尝�?[展开其成员为多个普通参数](https://www.aardio.com/zh-cn/doc/library-guide/builtin/raw/struct#by-val)�?
...
[Markdown 格式](https://www.aardio.com/zh-cn/doc/library-guide/builtin/raw/datatype.md)
