...
因为放弃了跨平台的负担，aardio 大幅降低了桌面软件开发的复杂度，也因此可以专注发挥和利用 Windows 的特性和优势。没有跨平台负担所带来的回报是丰厚的。例�?aardio 的图形界面库就只用了少量�?aardio 代码编写，而且很好用。甚至整�?aardio 标准库基本都是用�?aardio 代码编写的�?
...
6. 完美支持 Unicode
   ...
   拥有独特�?UTF 自动标记特性，不但完美支持 Unicode，也可方便地处理二进制数据�?
7. 支持第三方语言
